...
class RovingMossgiantDialogue
@Inject
constructor() : PluginScript() {
    override fun ScriptContext.startup() {
        onOpNpc1(GenericNpcs.roving_mossgiant) {
            player.roving_mossgiantDialogue(it.npc)
        }
    }

    private suspend fun ProtectedAccess.roving_mossgiantDialogue(npc: Npc) =
        startDialogue(npc) {
            chatNpc(happy, "Hello! I am roving_mossgiant.")
