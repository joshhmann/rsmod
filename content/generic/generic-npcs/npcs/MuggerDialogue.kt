...
class MuggerDialogue
@Inject
constructor() : PluginScript() {
    override fun ScriptContext.startup() {
        onOpNpc1(GenericNpcs.mugger) {
            player.muggerDialogue(it.npc)
        }
    }

    private suspend fun ProtectedAccess.muggerDialogue(npc: Npc) =
        startDialogue(npc) {
            chatNpc(happy, "Hello! I am Mugger.")
