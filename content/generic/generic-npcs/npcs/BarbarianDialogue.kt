...
constructor() : PluginScript() {
    override fun ScriptContext.startup() {
        onOpNpc1(GenericNpcs.barbarian) {
            player.barbarianDialogue(it.npc)
        }
    }

    private suspend fun ProtectedAccess.barbarianDialogue(npc: Npc) =
        startDialogue(npc) {
            chatNpc(happy, "Hello! I am Barbarian.")
