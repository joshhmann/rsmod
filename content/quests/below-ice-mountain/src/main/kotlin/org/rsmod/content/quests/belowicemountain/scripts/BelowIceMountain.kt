...
constructor(
    ...
    override fun ScriptContext.startup() {
        ...
        onOpNpc1(bim_npcs.willow_outside) { willowDialogue(it.npc) }
    ...
    private val ProtectedAccess.questStage: Int
        get() = vars[bim_varbits.quest_progress]
    ...
    private suspend fun ProtectedAccess.willowDialogue(npc: Npc) {
        when (questStage) {
            0 -> startQuest(npc)
            1, 2, 3, 4, 5 -> {
                chatNpc(npc, null, "Found my crew yet? Checkal is in Barbarian Village, " +
                    "Burntof is at the Rising Sun Inn in Falador, and Marley hangs around Edgeville.")
                chatPlayer(null, "I'm working on it!")
            }
            6 -> {
                chatPlayer(null, "I've found your old crew! Checkal, Burntof and Marley have all agreed to come!")
                chatNpc(npc, null, "You did it! I knew I picked the right person! " +
                    "Let's not waste any time. Follow me to the entrance!")
                chatPlayer(null, "Lead the way!")
                setQuestStage(7)
            ...
            7, 8 -> {
                chatNpc(npc, null, "You're a true hero! The ruins are open to explore now.")
            }
            else -> {
                chatNpc(npc, null, "Oh, hello there! Adventures to be had!")
            }
        }
    }

    private suspend fun ProtectedAccess.startQuest(npc: Npc) {
        chatNpc(npc, null, "Oh, hello there! You look like someone who's " +
            "not afraid of a bit of adventure!")
        chatNpc(npc, null, "I'm Willow, and I'm putting together an expedition " +
            "to explore some ancient ruins I've discovered beneath Ice Mountain!")
        chatNpc(npc, null, "I used to have a crew — Checkal the strongman, Burntof the " +
        ...
        if (choice != 1) {
            chatNpc(npc, null, "Oh... well, if you change your mind, I'll be here.")
            return
        }

        chatNpc(npc, null, "Excellent! First, find Checkal in Barbarian Village. " +
            "He's the strong one. Then Burntof in Falador's Rising Sun Inn. " +
            "And Marley is usually lurking around Edgeville.")
        chatPlayer(null, "I'll track them down and bring them back!")
        setQuestStage(1)
        questStarted()
    }
    ...
    private suspend fun ProtectedAccess.willowInsideDialogue(npc: Npc) {
        when (questStage) {
            7 -> {
                chatNpc(npc, null, "We need to get out of here! " +
                    "That guardian is too powerful!")
            }
            8 -> {
                chatNpc(npc, null, "You actually defeated it! I'm so sorry for lying " +
                    "to you, but... now we can explore these ruins properly!")
            }
            else -> {
                chatNpc(npc, null, "These ruins are incredible! Have a look around!")
            }
        }
    }
    ...
    private suspend fun ProtectedAccess.atlasDialogue(npc: Npc) {
        when (questStage) {
            0 -> {
                chatNpc(npc, null, "Welcome to The Long Hall! " +
                    "Want to learn some proper barbarian training?")
            }
            1 -> {
                chatPlayer(null, "I need to learn how to flex properly to impress Checkal!")
                chatNpc(npc, null, "Checkal, eh? That old softie. He used to be " +
                ...
                if (choice != 1) {
                    chatNpc(npc, null, "Suit yourself. The offer stands.")
                    return
                }

                mes("Atlas puts you through an intense training montage!")
                mes("You learn the ancient barbarian technique — the Flex emote!")
                chatNpc(npc, null, "There you go! Now go show Checkal what you've learned!")
                chatNpc(npc, null, "And take this beer and meat — you've earned it!")
            ...
            in 2..8 -> {
                chatNpc(npc, null, "Looking strong! Keep up the training!")
            }
            else -> {
                chatNpc(npc, null, "Welcome to The Long Hall!")
            }
    ...
    private suspend fun ProtectedAccess.checkalDialogue(npc: Npc) {
        when (questStage) {
            0 -> {
                chatNpc(npc, null, "Hey there. Looking for a workout?")
                chatPlayer(null, "Are you Checkal? Willow sent me.")
                chatNpc(npc, null, "Willow? That liar! She abandoned us in " +
                    "the last expedition. No way I'm going back.")
                chatPlayer(null, "She said you were the strongest person she knew.")
                chatNpc(npc, null, "Ha! Well, I WAS strong. But I've let myself go. " +
                    "These days I can barely lift a barrel of ale.")
                chatNpc(npc, null, "Come back when you've learned how to really flex. " +
                    "Maybe Atlas at The Long Hall can teach you.")
            }
            1 -> {
                chatPlayer(null, "Willow wants you back on the team! " +
                    "The ruins beneath Ice Mountain!")
                chatNpc(npc, null, "Still on about that? Prove you've got what it takes. " +
                    "Go see Atlas at The Long Hall and learn the Flex emote. " +
                    "Impress me, and I'm in.")
            }
            2 -> {
                chatPlayer(null, "Check it out — I learned the Flex emote! See?")
                chatNpc(npc, null, "Whoa! Now THAT's some muscle! Okay, I'm impressed!")
                chatNpc(npc, null, "Alright, I'm in! Willow might be trouble, but anyone " +
            ...
            in 3..7 -> {
                chatNpc(npc, null, "I'm ready whenever you are! " +
                    "Just say the word and I'll meet you at Ice Mountain.")
            }
            8 -> {
                chatNpc(npc, null, "You handled that guardian like a true warrior! " +
                    "Who needs flexing when you've got that kind of strength!")
            }
            else -> {
                chatNpc(npc, null, "Hey there!")
            }
        }
    }
    ...
    private suspend fun ProtectedAccess.burntofDialogue(npc: Npc) {
        when (questStage) {
            0 -> {
                chatNpc(npc, null, "Hic! Go 'way, I'm busy... hic!")
            }
            1 -> {
                chatPlayer(null, "Are you Burntof? I'm here to take you to Willow's expedition!")
                chatNpc(npc, null, "Willow?! That backstabber! Hic! She left us to rot " +
                    "in that goblin cave! I'm not going anywhere with her!")
                chatNpc(npc, null, "Now if you'll excuse me, I'm trying to drink " +
                    "away the memory. Hic!")
            }
            2, 3 -> {
                if (hasBeerOrAle) {
                    chatPlayer(null, "I brought you a drink!")
                    giveBurntofDrink(npc)
                } else {
                    chatNpc(npc, null, "Hic! Go 'way unless you've got a drink! Hic!")
                    chatPlayer(null, "I should find him some ale...")
                }
            }
            in 4..7 -> {
                chatNpc(npc, null, "Hic! Ready to blow stuff up whenever you are! " +
                    "Just say the word!")
            }
            8 -> {
                chatNpc(npc, null, "That guardian didn't stand a chance against " +
                    "my explosives! Best expedition ever!")
            }
            else -> {
                chatNpc(npc, null, "Hic! Hello there!")
            }
        }
    }
    ...
    private suspend fun ProtectedAccess.giveBurntofDrink(npc: Npc) {
        ...
        chatNpc(npc, null, "Aaahhh! That's the stuff! Hic! Alright, you're alright! " +
            "Tell you what — beat me at Rock, Paper, Scissors, and I'm in!")
        playRockPaperScissors()
    }

    private suspend fun ProtectedAccess.playRockPaperScissors() {
        ...
        when (result) {
            "win" -> {
                ...
                mes("Hic! You beat me fair and square! " +
            ...
            "lose" -> {
                ...
                mes("Hah! You lost! Hic! Come back when you " +
                    "can beat me... hic!")
            }
        }
    }
    ...
    private suspend fun ProtectedAccess.marleyDialogue(npc: Npc) {
        when (questStage) {
            0 -> {
                chatNpc(npc, null, "Keep walking, pal. Nothing to see here.")
            }
            1, 2, 3 -> {
                chatPlayer(null, "Willow sent me! She wants you back for the expedition!")
                chatNpc(npc, null, "Willow? That backstabber left us to die! " +
                    "I'm not going anywhere with her.")
                chatNpc(npc, null, "Unless... you can make it worth my while. " +
                    "I've got a taste for steak sandwiches. Bring me one, " +
                    "and maybe I'll consider it.")
                chatPlayer(null, "A steak sandwich? Where would I find one?")
                chatNpc(npc, null, "How should I know? You're the adventurer! " +
                    "Cooked meat, bread, and a knife... figure it out.")
            }
            4 -> {
                if (hasSteakSandwich) {
                    chatPlayer(null, "I've brought you a steak sandwich!")
                    giveMarleySteakSandwich(npc)
                } else {
                    chatNpc(npc, null, "Got that steak sandwich yet? " +
                        "I'm getting hungry over here!")
                    chatPlayer(null, "Not yet, but I'm working on it!")
                    chatNpc(npc, null, "Well don't keep me waiting! " +
                        "Cooked meat, bread, and a knife is all you need.")
                }
            }
            in 5..7 -> {
                chatNpc(npc, null, "I'm in! Can't wait to see what's in those ruins!")
            }
            8 -> {
                chatNpc(npc, null, "That was the best heist I've ever been on! " +
                    "Well, not a heist exactly, but still!")
            }
            else -> {
                chatNpc(npc, null, "What do you want?")
            }
        }
    }
    ...
    private suspend fun ProtectedAccess.giveMarleySteakSandwich(npc: Npc) {
        ...
        chatNpc(npc, null, "Oh wow, this looks delicious! Thanks pal!")
        mes("Marley takes a big bite of the steak sandwich.")
        chatNpc(npc, null, "Mmm! Alright, you've got a deal! " +
    ...
    private suspend fun ProtectedAccess.guardianDialogue(npc: Npc) {
        when (questStage) {
            7 -> {
                chatNpc(npc, null, "INTRUDER! YOU SHALL NOT PASS!")
                val choice = simChoice2(
                ...
                if (choice == 1) {
                    ...
                    chatNpc(npc, null, "THERE IS NO REASONING! ONLY DESTRUCTION!")
                    fightGuardian()
                }
            }
            8 -> {
    ...
    private suspend fun ProtectedAccess.ramarnoDialogue(npc: Npc) {
        when (questStage) {
            7 -> {
                chatNpc(npc, null, "You there! Did you defeat the guardian? " +
                    "I'm Ramarno, an Imcando dwarf. These ruins are my ancestors' work!")
                chatPlayer(null, "Not yet, but I'm working on it!")
                chatNpc(npc, null, "Be careful in there. The guardian protects " +
            ...
            8 -> {
                ...
                chatNpc(npc, null, "Welcome to the Camdozaal ruins, adventurer. " +
    ...
    private suspend fun ProtectedAccess.completeQuest(npc: Npc) {
        chatNpc(npc, null, "You did it! You defeated the guardian and " +
            "freed the Sacred Forge from its control!")
        chatNpc(npc, null, "I am Ramarno, last of the Imcando dwarves. " +
        ...
        chatPlayer(null, "What happens now?")
        chatNpc(npc, null, "Now the forge is free! Any skilled smith can use it. " +
    ...
    private suspend fun ProtectedAccess.questRewards(npc: Npc) {
        ...
        chatNpc(npc, null, "The Sacred Forge is now open for business. " +
            "Feel free to explore the ruins — there's much to discover!")
        chatPlayer(null, "Thank you, Ramarno! I'll be sure to visit again.")
    ...
    // ===========================================================================
    // Simulated menu choices (no real gh-interface)
    // ===========================================================================
    ...
    private suspend fun ProtectedAccess.simChoice3(
        opt1: String,
        opt2: String,
        opt3: String,
    ): Int {
