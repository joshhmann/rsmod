...
public value class RouteCoordinates(public val packed: Int) {
    public val x: Int
        get() = (packed shr 14) and 0x3FFF

    public val z: Int
        get() = packed and 0x3FFF

    public val level: Int
        get() = (packed shr 28) and 0x3
    ...
    public fun translate(xOffset: Int, zOffset: Int, levelOffset: Int = 0): RouteCoordinates =
        RouteCoordinates(x = x + xOffset, z = z + zOffset, level = level + levelOffset)
