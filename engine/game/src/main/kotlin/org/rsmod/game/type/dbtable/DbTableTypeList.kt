...
public data class DbTableTypeList(public val types: MutableMap<Int, UnpackedDbTableType>) :
    ...
    public operator fun get(type: DbTableType): UnpackedDbTableType =
        getOrNull(type) ?: throw NoSuchElementException("Type is missing in the map: $type.")

    public fun getOrNull(type: DbTableType): UnpackedDbTableType? = types[TypeResolver[type]]
