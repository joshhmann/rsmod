...
public data class UnpackedHuntModeType(
    ...
    public val rate: Int,
    public val checkInvObj: HuntCondition.InvCondition?,
    public val checkInvParam: HuntCondition.InvCondition?,
    public val checkLoc: HuntCondition.LocCondition?,
    public val checkNpc: HuntCondition.NpcCondition?,
    public val checkObj: HuntCondition.ObjCondition?,
    public val checkVar1: HuntCondition.VarCondition?,
    public val checkVar2: HuntCondition.VarCondition?,
    public val checkVar3: HuntCondition.VarCondition?,
