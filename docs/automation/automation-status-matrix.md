...
|-----------------|:----------:|---------------|-------|
| **Drop tables** | **Level 5** | `8420e7dc`, `3ff81785`, `fb5d6beb`, `f1e0466a` | Proven across 5 phases, 20+ NPC families. Draynor validated (no workflow changes). Ready for batch regional expansion |
