...
class Js5Store(val crc: IntArray, val responses: Int2ObjectMap<ByteBuf>) {
    ...
    companion object {
        fun from(store: Store): Js5Store {
            ...
            val crc = masterIndex.entries.map { it.checksum }.toIntArray()
            return Js5Store(crc, responses)
        }
