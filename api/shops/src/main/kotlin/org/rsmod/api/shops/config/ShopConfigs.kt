...
public object ShopInterfaces : InterfaceReferences() {
    public val shop_main: InterfaceType = find("shopmain")
    public val shop_side: InterfaceType = find("shopside")
}

public object ShopComponents : ComponentReferences() {
    public val shop_subtext: ComponentType = find("shopmain:desktop_instructions")
    public val shop_side_inv: ComponentType = find("shopside:items")
    public val shop_inv: ComponentType = find("shopmain:items")
}
